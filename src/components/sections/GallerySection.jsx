...
const GallerySection = ()=>{
    return(
        <main class="pt-32 pb-24 bg-primary-container z-50 relative overflow-hidden">
<div class="absolute inset-0 bg-grain pointer-events-none"></div>
<header class="relative z-10 text-center mb-20 px-6">
<h3 class="font-script text-secondary-fixed-dim text-4xl md:text-5xl mb-4">A year of beautiful moments</h3>
<h2 class="font-serif-italic italic text-surface text-6xl md:text-8xl tracking-tight opacity-90">Our Gallery</h2>
</header>
...
<div class="absolute bottom-0 right-0 w-64 h-64 opacity-10 pointer-events-none translate-x-1/4 translate-y-1/4">
<svg class="fill-tertiary-fixed" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
