    ...
    <section className="bg-surface py-32 px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 relative">
          ...
          <motion.h2
            className="font-display italic text-5xl md:text-6xl text-primary-container mb-8 leading-tight"
          ...
          <motion.p
            className="font-body text-lg text-on-surface-variant leading-relaxed mb-12 max-w-md"
          ...
          >
            <Link
              href="/gallery"
              className="group flex items-center space-x-4 bg-primary-container text-white px-8 py-4 rounded-md transition-all duration-500 hover:bg-secondary w-fit"
            >
        ...
        {/* ── Right column ── */}
        <motion.div
          className="lg:col-span-7 grid grid-cols-2 gap-6 items-end"
        ...
        >
          ...
          <div className="space-y-6">
            <motion.div
              className="aspect-3/4 rounded-sm overflow-hidden shadow-2xl relative w-full min-h-75"
              variants={fadeIn(0.3)}
              initial="hidden"
              whileInView="visible"
              viewport={viewport}
            ...
            <motion.div
              className="p-6 bg-surface-container-low rounded-sm italic font-display text-xl text-primary-container"
          ...
          <div className="space-y-6 pb-20">
            <motion.div
              className="p-8 bg-tertiary-fixed/30 rounded-sm"
              variants={fadeUp(0.35)}
              initial="hidden"
              whileInView="visible"
              viewport={viewport}
            >
              <span className="font-script text-3xl text-on-tertiary-fixed-variant block mb-2">
                Favour
              </span>
              <p className="font-display text-lg leading-relaxed text-on-tertiary-fixed-variant">
            ...
            >
              ...
              />
              <div className="absolute bottom-4 right-4 font-script text-2xl text-white drop-shadow-lg">
                Forever yours
              </div>
            </motion.div>
          </div>
